# import during verify bug fixed - sixpack 2015 (line 226 modified)
    ...
    def handle_status(self, key, value):
        if key in self.TRUST_LEVELS:
            ...
            self.trust_level = self.TRUST_LEVELS[key]
                     ...
                     "GOODMDC", "NO_SGNR", "NOTATION_NAME", "NOTATION_DATA","IMPORTED","IMPORT_OK"): # Add IMPORTED and IMPORT_OKto prevent recv_keys error
            pass
        elif key == "BADSIG":
            self.valid = False
