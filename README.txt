...
[This initial set-up creates an encrypted database file (by default into ~/.dnmg/storage.db) and a PGP encrypted file called secret which will go into ~/.dnmg/secret]
